...
class HomeController extends Controller
{
    ...
    {
      SEOMeta::setTitle('Infoware Nepal Pvt. Ltd.');
    ...
    public function team()
    {
      ...
      SEOMeta::setTitle('Our team Infoware Nepal Pvt Ltds');
    ...
    public function blogsearch()
    {
      $q = Input::get ( 'q' );
      if($q != ""){
      $abc = Post::where ( 'title', 'LIKE', '%' . $q . '%' )->orWhere ( 'subtitle', 'LIKE', '%' . $q . '%' )->paginate (6)->setPath ( '' );
      ...
      if (count ($abc) > 0){
          ...
          return view ( 'blog1' )->withMessage( 'No Details found. Try to search again !' );
  }  }
}
